import{$ as o,r as n,j as a,G as x,s as u}from"./index-BEvZb9a2.js";import{c as i}from"./utils-DaT-yT0k.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const j=[["path",{d:"M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915",key:"1i5ecw"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]],E=o("settings",j);/**
 * @license lucide-react v1.30.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _=[["path",{d:"M10 11v6",key:"nco0om"}],["path",{d:"M14 11v6",key:"outv1u"}],["path",{d:"M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6",key:"miytrc"}],["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2",key:"e791ji"}]],$=o("trash-2",_),d=n.createContext({open:!1,setOpen:()=>{}});function I({open:e,defaultOpen:t,onOpenChange:s,children:c}){const[r,l]=n.useState(!!t),p=e!==void 0?e:r,m=y=>{e===void 0&&l(y),s==null||s(y)};return a.jsx(d.Provider,{value:{open:p,setOpen:m},children:c})}function P({children:e,asChild:t}){const{setOpen:s}=n.useContext(d);return t&&n.isValidElement(e)?n.cloneElement(e,{onClick:c=>{var r,l;(l=(r=e.props).onClick)==null||l.call(r,c),s(!0)}}):a.jsx("button",{type:"button",onClick:()=>s(!0),children:e})}function T({className:e,children:t}){const{open:s,setOpen:c}=n.useContext(d);return s?x.createPortal(a.jsxs("div",{className:"fixed inset-0 z-[120] flex items-center justify-center p-4",role:"dialog",children:[a.jsx("div",{className:"absolute inset-0 bg-black/50",onClick:()=>c(!1)}),a.jsxs("div",{className:i("glass-modal relative z-10 w-full max-w-lg max-h-[88vh] overflow-y-auto rounded-3xl p-5 shadow-2xl",e),children:[a.jsx("button",{onClick:()=>c(!1),"aria-label":"Close",className:"absolute right-3 top-3 grid h-8 w-8 place-items-center rounded-full text-lg opacity-60 hover:bg-ink/10 dark:hover:bg-white/10",children:"×"}),t]})]}),document.body):null}const V=({className:e,...t})=>a.jsx("div",{className:i("mb-3 pr-6",e),...t}),H=({className:e,...t})=>a.jsx("div",{className:i("mt-4 flex flex-wrap justify-end gap-2",e),...t}),S=({className:e,...t})=>a.jsx("h2",{className:i("text-lg font-bold",e),...t}),A=({className:e,...t})=>a.jsx("p",{className:i("text-sm opacity-65",e),...t});function L(e){u.functions.invoke("notify-new-message",{body:{recipient_id:e.recipientId,sender_id:e.senderId,message_preview:e.messagePreview,message_type:e.messageType||"text"}}).catch(()=>{})}export{N as C,I as D,D as E,C as I,z as P,E as S,$ as T,T as a,V as b,S as c,A as d,H as e,M as f,P as g,L as n};
