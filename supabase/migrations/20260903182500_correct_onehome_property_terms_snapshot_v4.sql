-- The public review UI for the current owner-handoff fixtures displays COP
-- 8,600,000 monthly rent. Version the acknowledgement snapshot so the stored
-- legal evidence matches the text the signer reviewed, and describe the
-- snapshot per listing instead of naming an obsolete two-listing set.
