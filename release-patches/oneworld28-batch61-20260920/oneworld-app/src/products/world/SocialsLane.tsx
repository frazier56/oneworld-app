...
export function useSocialsLane(lang: string, query: string, enabled: boolean) {
  ...
  const cards: LaneCard[] = useMemo(() => (posts ?? [])
    ...
    .map(p => {
      ...
      return {
        ...
        who: a ? { name: a.full_name, photo: a.photo_url, score: a.score } : null,
        ...
        engagement: { source: "media_post" as const },
      };
    }), [posts, authors, platforms, needle, lang]);
