...
import { MessagesScreen, ThreadScreen, ProfileScreen, PublicWorld, SettingsScreen, lazyScreen, ScreenFallback} from "@oneworld/shell";
 ...
 */
function Providers() { return <Suspense fallback={<ScreenFallback />}><Outlet /></Suspense>; }
