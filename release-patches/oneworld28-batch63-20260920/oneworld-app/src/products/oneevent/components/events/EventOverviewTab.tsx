    ...
    <div className="space-y-6">
      <div className="grid grid-cols-2 gap-3">
        {quickActions.map((action) => (
          <button key={action.label} onClick={action.onClick} className={cn("min-h-[92px] rounded-2xl border px-3 py-4 text-sm font-bold transition-all shadow-[inset_0_1px_0_rgba(255,255,255,.35),0_12px_30px_rgba(0,0,0,.08)] backdrop-blur-xl", action.primary ? "border-primary/70 bg-gradient-to-br from-primary to-primary/80 text-primary-foreground hover:opacity-95" : "border-white/55 bg-card/75 text-foreground hover:bg-primary/10" )}>
