...
>
      ...
      {!isPayee && (
        <>
          <button onClick={() => setWhatNextOpen((v) => !v)} aria-expanded={whatNextOpen} className="mt-3 flex w-full items-center justify-center gap-1.5 border-t ow-edge pt-3 text-[12px] font-bold opacity-75">
