...
const TABLES: Record<string, unknown[]> = {
  ...
  jobs: [
    { id: "77777777-0000-4000-8000-000000000001", title: "Replace a water heater, Belhaven", description: "Forty gallon gas unit, supplied. Half a day.", location: "Jackson, MS", pay_type: "fixed", pay_range: null, fixed_pay_amount: 650, category: "Plumbing", status: "live", direct_recipient_id: null, created_at: new Date().toISOString() },
    { id: "77777777-0000-4000-8000-000000000002", title: "Photograph a 200-seat gala", description: "Six hours, edited gallery within a week.", location: "Atlanta, GA", pay_type: "range", pay_range: "$900 - $1,400", fixed_pay_amount: null, category: "Photography", status: "live", direct_recipient_id: null, created_at: new Date(Date.now() - 36e5).toISOString() },
  ...
  sale_properties: [
    /* ── TWO PUBLISHED SALE LISTINGS (World Feed 30, 20 Sep 2026) ────────────────────────────
       ...
       filter cannot be photographed in either position. Sale rows carry `photos` and no video,
       which is the real shape of that table today. */
