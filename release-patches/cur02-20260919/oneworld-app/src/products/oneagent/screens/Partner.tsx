  ...
  return (
    <div className="space-y-5">
      ...
      <div className="text-center">
        {qr
          ? <img decoding="async" src={qr} alt="QR" className="mx-auto w-[230px] rounded-xl bg-white p-2 shadow-sm" />
        ...
        <div className="mt-3 flex items-center gap-2 rounded-xl border border-ink/10 px-3 py-2.5 dark:border-white/15">
          ...
          <button onClick={copy}
 className="ow-edge ow-tap shrink-0 rounded-lg border px-3 py-1.5 text-[12px] font-bold ">
