...
export default function ProfileCalendar({ userId }: { userId: string }) {
 ...
 <button key={e.id + e.kind} onClick={() => nav(`/events/e/${e.id}`)} className="ow-edge flex w-full items-center gap-3 rounded-xl border p-2.5 text-left transition hover:bg-teal/5 ">
