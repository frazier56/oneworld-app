...
const COPY = {
  ...
  cleaningFee:   { en: "Cleaning fee", es: "Aseo", de: "Reinigungsgebühr", ru: "Уборка", zh: "清洁费", pt: "Taxa de limpeza" },
  cleaningToHost:{ en: "Paid to the host with the rent.", es: "Se paga al anfitrión junto con el canon.", de: "Wird mit der Miete an den Gastgeber gezahlt.", ru: "Оплачивается хозяину вместе с арендой.", zh: "与租金一同支付给房东。", pt: "Pago ao anfitrião junto com o aluguel." },
