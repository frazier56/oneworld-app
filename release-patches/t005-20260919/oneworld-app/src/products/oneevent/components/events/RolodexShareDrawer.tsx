  ...
  return (
    ...
    >
      <div
        ...
        className="w-full sm:max-w-md max-h-[calc(100dvh-env(safe-area-inset-bottom)-120px)] sm:max-h-[90svh] overflow-y-auto overscroll-contain bg-card border border-border rounded-2xl shadow-2xl shadow-black/40"
      >
          ...
          <div className="p-4 sm:p-5 space-y-4 sm:space-y-5">
            ...
            <section>
              ...
              <div className="flex items-start gap-3">
                {qrDataUrl ? (
                  <img decoding="async" src={qrDataUrl} alt="QR code" className="w-28 h-28 sm:w-40 sm:h-40 rounded-lg border border-border bg-white p-2 shrink-0" />
                ) : (
