    ...
    <div className="space-y-4">
      ...
      <Section label={W(lang, "Your properties", "Sus inmuebles")}>
        ...
        <Opt d={P.home} primary
          ...
          /* The count that used to be a chip. It is the same two numbers, now labelled. */
        ...
        <Opt d={P.rentSign}
          /* ⚠️ A TITLE IS A LABEL, NOT A SENTENCE. Lee, 14 Sep 2026: *"It's wrapping the text…
             the best way to do that is to reword it to probably say drafts or something. Draft
             listings."* "Continue your unfinished listing" is four words of instruction where two
             words of noun will do, and the instruction was already in the grey line underneath.
             Same rule as the buttons: the label names the thing, the copy around it explains. */
          ...
          sub={counts?.latestDraft
            /* The grey line carries the instruction the title used to: which draft, and that
               tapping resumes it. */
            ? W(lang,
