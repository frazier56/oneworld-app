...
export default function Alerts() {
  ...
  return (
    <div className="space-y-3">
      <ScreenHeading right={unread> 0 && userId ? ( <button onClick={markAll} className="rounded-full border ow-edge px-3 py-1.5 text-xs font-semibold"> {W(lang,"Mark all read","Marcar todo como leído")} </button> ) : null}>{W(lang, "Notifications", "Notificaciones")}</ScreenHeading>
