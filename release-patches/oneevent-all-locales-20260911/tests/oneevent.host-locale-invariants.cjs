...
assert.match(dialog, /relativeDayMatch/);
assert.match(dialog, /\{count\} day away/);
assert.match(dialog, /\{count\} days away/);
assert.ok(language.includes('"{count} day away": "Falta {count} día"'));
assert.ok(language.includes('"{count} days away": "Faltan {count} días"'));
