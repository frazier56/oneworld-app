  ...
  return (
    <Router basename={BASENAME}>
      ...
      <Routes>
        ...
        {/* On the TEST SITE the front door is the world feed, because that is what the feed is
            being built to become. On production the front door is unchanged and stays unchanged
            until Lee says otherwise — `IN_SANDBOX` is false there, always. This is also why the
            test site needs no second address: one word, one door. */}
        <Route path="/" element={
          IN_SANDBOX
