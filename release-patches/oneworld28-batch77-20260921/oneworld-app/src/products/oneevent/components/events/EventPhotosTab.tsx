            ...
            {media.map((item, i) => (
              <div key={i} className="relative group rounded-xl overflow-hidden aspect-square">
                {item.type === "video" ? (
                  ...
                  <img decoding="async" src={item.url} alt={item.name} className="w-full h-full object-cover" />
                )}
...
>
      ...
      <Dialog open={showAttendeePicker} onOpenChange={setShowAttendeePicker}>
        <DialogContent className="max-w-md max-h-[80svh] overflow-hidden flex flex-col">
          <DialogHeader>
...
>
                  ...
                  <img decoding="async" src={avatarUrl(r.profile)} alt="" className="w-9 h-9 rounded-full object-cover flex-shrink-0" />
