...
/* v5.2 — Skip pill out of the picture, last second dissolving into the signed-out home. Each cut
   ships under its OWN name: staging is add-only, so writing over a path already in the repo is a
   hard stop, and it would break rollback for every batch still pointing at the older file. */
