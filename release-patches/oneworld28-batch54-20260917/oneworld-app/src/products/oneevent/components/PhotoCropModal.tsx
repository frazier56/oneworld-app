...
export default function PhotoCropModal({ file, onDone, onCancel }:
 ...
 <button onClick={onCancel} className="ow-edge grid h-8 w-8 place-items-center rounded-full border text-lg" aria-label="Close">×</button>
        </div>
        ...
        <div className="mx-auto touch-none overflow-hidden rounded-2xl bg-black/80 select-none"
          ...
          <img decoding="async" src={url} onLoad={onLoad} draggable={false} alt=""
