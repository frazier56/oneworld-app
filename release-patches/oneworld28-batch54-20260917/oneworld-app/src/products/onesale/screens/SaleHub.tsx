...
export default function SaleHub() {
  ...
  return (
    <div className="space-y-4">
      ...
      <Section label={W(lang, "Looking to buy", "Buscando comprar")}>
      ...
      {/* ── LISTING ──────────────────────────────────────────────────────────────────────── */}
      {/* ⚠️ THE TWO HUBS MUST NAME THINGS THE SAME WAY (Lee, 19 Sep 2026) ───────────────────
          *"My properties for sale, my properties for rent. Probably that's it."* The rent hub was
          regrouped around what a person OWNS rather than what they are doing; these two headings
          said "You're selling" and "You're renting" for the same rows, so one tap on the Renting /
          Selling toggle renamed every category the host had just learned. Same nouns, both sides.
          The looking section keeps its own heading — it is not about their properties at all. */}
...
/* No chevron, 40px icon — see the note on the rent hub's `Opt` for the measurement. */
