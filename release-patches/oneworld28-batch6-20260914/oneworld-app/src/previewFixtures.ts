...
export const SHOT_IDS = { PROP, REQ };
...
const TABLES: Record<string, unknown[]> = {
  ...
  rental_properties: [{
    ...
    photos: [], videos: [], city: "Medellín", neighbourhood: "El Poblado", country: "CO",
    updated_at: new Date().toISOString(), created_at: new Date().toISOString(),
  }, {
    id: PROP, agent_id: ME, title: "Bright two-bedroom in El Poblado",
    ...
    city: "Medellín", neighbourhood: "El Poblado", country: "CO", address_line: "Carrera 43A #7-50",
  ...
  rental_booking_requests: [{
    ...
    quoted_total: 50400000, guest_total: 54180000,
