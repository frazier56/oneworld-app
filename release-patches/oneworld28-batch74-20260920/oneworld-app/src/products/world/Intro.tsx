...
export default function Intro({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <div role="dialog" aria-modal="true"
      ...
      className="absolute inset-0 z-50 flex flex-col items-center justify-end bg-ink/70 px-[18px] pb-[110px] backdrop-blur-md">
      ...
      <div className="w-full max-w-[440px] rounded-3xl border border-white/20 bg-white/[0.14] p-[18px]
        text-white backdrop-blur-2xl backdrop-saturate-150"
        style={{ boxShadow: "inset 0 1px 0 rgba(255,255,255,.28), 0 18px 46px rgba(0,0,0,.5)" }}>
        ...
        <button type="button"
          className="ow-tap grid h-[50px] w-full place-items-center rounded-2xl bg-clay text-[15px] font-extrabold text-white transition active:scale-[.98]"
