    ...
    <div className="fixed inset-0 z-0 flex justify-center bg-black">
      ...
      {railVisible && (
        /* ⚠️ THE RAIL DOES NOT HIDE. It belongs to the item, like the information block, and it
           ...
           hide on a swipe up. */
        <div data-ow="rail"
          /* THE GAP IS 20 PX (R28), DOWN FROM 36. Lee: *"the icons are spaced way too far out
             — you have this thing around 75% of the vertical space. Cut the space in half...
             you got out of hand with the spacing."* Six controls at 48 px each is 288 px that
             cannot move; the gap is the only dial. 36 put the column at 468 px, which on an
             844-tall phone runs from a third of the way down to the footer and reads as owning
             the screen. 20 brings it to 388 and the rail reads as a rail again.
