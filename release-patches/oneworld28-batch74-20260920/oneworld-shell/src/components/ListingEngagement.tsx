  ...
  return (
    <div>
      {/* ⚠️ `gap-1` BETWEEN THESE THREE WAS THE REST OF THE SPACING BUG (R27), and the number
           ...
           apart inside a column that was otherwise breathing. It is 20 px here and 20 px on the
           rail: one number, both places, or the column spaces itself unevenly. */}
      <div className={`flex ${vertical ? "flex-col items-center gap-5" : "items-center gap-1"} ${size} ${onDark ? "text-white" : ""}`}>
