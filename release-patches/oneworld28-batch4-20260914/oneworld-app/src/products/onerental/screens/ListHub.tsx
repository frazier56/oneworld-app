      ...
      <Section label={W(lang, "Your properties", "Sus inmuebles")}>
        ...
        <Opt d={P.rentSign}
          title={counts?.latestDraft
            ? W(lang, "Continue your unfinished listing", "Continuar su anuncio sin terminar")
            : W(lang, "List a property for rent", "Publicar en arriendo")}
          sub={counts?.latestDraft
            ? (counts.latestDraft.title?.trim()
                || W(lang, "Untitled draft — pick up where you left off",
                           "Borrador sin título — retome donde lo dejó"))
