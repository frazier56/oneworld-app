...
export default function RosterMember() {
 ...
 className="ow-edge ow-tap mt-3 inline-flex items-center justify-center rounded-xl border px-4 py-2 text-[13px] font-semibold ">
 ...
 className="ow-edge ow-tap block rounded-xl border px-3 py-2.5 ">
              <div className="flex items-center justify-between gap-3">
 ...
 className="ow-edge ow-tap w-full rounded-2xl border px-5 py-3 text-sm font-bold text-red-600 ">
            {t("disconnect")}
          </button>
          {disconnectAsked && (
