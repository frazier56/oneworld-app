...
export function altPrice(usdAmount: number, country: string | null | undefined, viewerCcy: string, rate: number | null | undefined, cop: (usd: number, rate: number) => string, usd: (n: number) => string): string | null {
