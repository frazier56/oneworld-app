  ...
  return (
    <div className={cn(
      ...
      <div ref={ref} contentEditable suppressContentEditableWarning data-placeholder={placeholder}
        ...
        className="oj-rte-body min-h-[120px] max-h-[420px] resize-y overflow-auto px-4 py-3 pb-7 outline-none empty:before:opacity-40 empty:before:content-[attr(data-placeholder)]" />

      {/* The one grip.
          Chrome's native resizer is painted out in index.css (.oj-rte-body::-webkit-resizer), so
