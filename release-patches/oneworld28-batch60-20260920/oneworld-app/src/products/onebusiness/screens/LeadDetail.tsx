...
export default function LeadDetail() {
 ...
 className={`ow-edge ow-tap rounded-full border px-3 py-1.5 text-[12px] font-bold ${s.terminal === "won" ? "border-emerald-600/40" : s.terminal === "lost" ? " opacity-70" : "border-brand/40"}`}>{s.label}</button>
          ))}</div>
