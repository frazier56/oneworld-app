  ...
  return (
    <div className="space-y-3">
      ...
      {noComposer ? null : composerLabel ? (
        ...
        <Link to={base}
 className="ow-edge ow-tap flex items-center gap-2 rounded-2xl border bg-white/70 px-3 py-2.5 dark:bg-white/10">
        ...
        <div className="card flex items-center gap-2 p-2.5">
          {ACTIONS.map(a => (
            <button
              ...
              disabled={!userId}
 className="ow-edge ow-tap flex min-w-0 flex-1 items-center justify-center gap-1.5 rounded-xl border border-ink/[0.07] bg-white/50 px-2 py-2 text-[12.5px] font-bold transition hover:bg-brand/5 disabled:opacity-40 dark:bg-white/[0.04]"
            >
