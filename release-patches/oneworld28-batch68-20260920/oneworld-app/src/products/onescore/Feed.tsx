          ...
          <div className="space-y-3">
                ...
                <button key={c.key} onClick={() => setPctFilter(c.key)}
                  className={`shrink-0 rounded-full border px-3 py-1.5 text-xs font-bold transition ${
                    pctFilter === c.key
                      ...
                      : "ow-edge text-ink/55 hover:text-ink dark:text-white/55 dark:hover:text-white"
                  }`}>
                  {c.label}
                </button>
              ))}
            ...
            {board.length ? (
              <div className="overflow-hidden rounded-2xl border border-ink/10 dark:border-white/10">
                ...
                <div className="flex items-center gap-3 border-b ow-edge bg-ink/[0.03] px-4 py-2 text-[10px] font-extrabold uppercase tracking-wider opacity-55 dark:bg-white/[0.04]">
