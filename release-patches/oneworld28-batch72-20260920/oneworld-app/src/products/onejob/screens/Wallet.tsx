...
export default function Wallet() {
 ...
 <button onClick={back} className="ow-edge mb-4 flex h-10 items-center gap-1 rounded-full border pl-2 pr-3.5 text-sm font-bold">‹ {returnTo ? W(lang, "Back to your contract", "Volver a tu contrato") : W(lang, "Back", "Atrás")}</button>
 ...
 <button onClick={() => setSel(null)} className="ow-edge grid h-8 w-8 place-items-center rounded-full border">‹</button>
...
function AddManualSheet({ type, userId, onClose, onSaved }:
  ...
  return (
    <div className="fixed inset-0 z-[86] grid place-items-end sm:place-items-center">
      ...
      <div className="glass-modal relative w-full max-w-lg rounded-t-3xl p-6 shadow-2xl sm:m-4 sm:rounded-3xl">
        <div className="mb-4 flex items-center justify-between">
 <button onClick={onClose} className="ow-edge grid h-8 w-8 place-items-center rounded-full border">‹</button>
