...
export default function ConnectScreen() {
  ...
  const AddForm = ({ p }: { p: Plat }) => (
    <div className="card col-span-4 space-y-2 !p-4">
      ...
      <input value={handle} onChange={e => setHandle(e.target.value)} placeholder={W(lang, p.ph.en, p.ph.es)} className="w-full rounded-xl border ow-edge bg-transparent px-3 py-2.5 text-sm outline-none placeholder:opacity-50" autoFocus />
