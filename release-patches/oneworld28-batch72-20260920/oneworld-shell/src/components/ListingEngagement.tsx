...
export default function ListingEngagement({
  ...
  const btn = `ow-tap flex font-bold transition ${vertical ? "min-h-0 flex-col items-center justify-center gap-0.5 px-0 text-[11px]" : "min-h-[44px] rounded-full items-center gap-1.5 px-3 py-2"}`;
