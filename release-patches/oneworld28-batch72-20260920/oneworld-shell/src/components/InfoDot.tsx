  ...
  return (
    <>
      ...
      <button
        ...
        aria-expanded={open}
        aria-label={WA(locale, { en: `What ${title} means`, es: `Qué significa: ${title}`, co: `Qué significa: ${title}`, de: `Was bedeutet ${title}?`, pt: `O que significa ${title}`, ru: `Что означает ${title}`, zh: `${title}是什么意思` })}
      ...
      {open && createPortal(
        <div
          ...
          <div
            ...
            className="glass-modal max-h-[80svh] w-full max-w-sm overflow-y-auto rounded-3xl p-5">
            <div className="flex items-start justify-between gap-3">
              ...
              <button
                type="button"
                onClick={() => setOpen(false)}
                aria-label={WA(locale, { en: "Close", es: "Cerrar", co: "Cerrar", de: "Schließen", pt: "Fechar", ru: "Закрыть", zh: "关闭" })}
