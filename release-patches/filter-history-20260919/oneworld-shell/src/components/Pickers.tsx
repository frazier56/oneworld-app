...
function Sheet({ children, onClose }: { children: React.ReactNode; onClose: () => void }) {
  // Date and time share this sheet: cancel must never commit a value or dismiss a parent dialog.
    ...
    <>
      ...
      {open && (
        <Sheet onClose={() => setOpen(false)}>
          ...
          <div className="grid max-h-[45svh] grid-cols-3 gap-1.5 overflow-y-auto pr-1">
            {slots.map(s => (
    ...
    <>
      ...
      {open && (
        <Sheet onClose={close}>
          ...
          <div className="max-h-[50svh] space-y-1 overflow-y-auto pr-1">
