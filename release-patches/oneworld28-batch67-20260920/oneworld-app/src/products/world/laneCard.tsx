...
function SlideVideo({ url, poster, sound, className }: {
  ...
  const zoneAt = (clientX: number): "ff" | "mid" | "rw" => {
    ...
    return f < SIDE_ZONE ? "ff" : f > 1 - SIDE_ZONE ? "rw" : "mid";
  };
  ...
  return (
    <div ref={box} className="absolute inset-0"
      ...
      <div
        className="absolute inset-x-0 top-0 z-[4] cursor-pointer py-3"
        ...
        <div className="h-[5px] w-full bg-white/25">
