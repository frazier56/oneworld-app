...
>
      ...
      {currentIsVideo ? (
        <video
          ...
          controls
          playsInline
          className="max-w-[92vw] max-h-[86svh] rounded-lg bg-black"
          onPointerDown={(e) => e.stopPropagation()}
          onClick={(e) => e.stopPropagation()}
        />
      ) : (
        <img decoding="async"           src={currentUrl}
          alt={`Media ${index + 1}`}
          draggable={false}
          className="max-w-[92vw] max-h-[86svh] object-contain rounded-lg pointer-events-none"
          style={{
