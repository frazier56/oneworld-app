...
export default function PassportStrip({
 ...
 <button onClick={() => setModal(false)} className="ow-edge grid h-9 w-9 shrink-0 place-items-center rounded-full border border-brand/25 text-xl " aria-label={isEs ? "Cerrar" : "Close"}>×</button>
            </div>
          </div>
