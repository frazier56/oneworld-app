...
export default function Intro({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <div role="dialog" aria-modal="true"
      className="absolute inset-0 z-50 flex flex-col justify-end bg-ink/70 px-[18px] pb-[110px] backdrop-blur-md">
      <div className="rounded-3xl border border-white/15 bg-[#151C2C] p-[18px] text-white">
