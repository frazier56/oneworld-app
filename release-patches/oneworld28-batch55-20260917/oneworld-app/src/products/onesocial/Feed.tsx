...
export default function Feed() {
              ...
              return (
                <article key={p2.id} className="card overflow-hidden p-0">
                  <div className="flex items-center gap-3 px-4 pt-3">
                    ...
                    <span className="flex shrink-0 items-center gap-1.5 rounded-full border ow-edge px-2.5 py-1 text-[11.5px] font-bold opacity-70 dark:border-white/15">
                  ...
                  {p2.media_url && (
                    p2.media_type.toUpperCase() === "VIDEO" ? (
                      ...
                      <img decoding="async" src={p2.media_url} alt={p2.caption ?? ""} loading="lazy"
 ...
 className="ow-edge ow-tap ml-auto flex items-center gap-1.5 rounded-full border px-3 py-1 text-[12px] font-bold opacity-100 transition hover:bg-brand/5 disabled:opacity-40 ">
