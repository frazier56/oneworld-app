            ...
            <div key={p.key} className="card p-4">
              ...
              {editing === p.key && !c && (
                <div className="mt-3 flex gap-2">
                  <input value={handle} onChange={e => setHandle(e.target.value)} placeholder={W(lang,"@yourhandle","@tuusuario")} className="w-full rounded-xl border ow-edge bg-transparent px-3 py-2 text-sm outline-none placeholder:opacity-50" autoFocus />
