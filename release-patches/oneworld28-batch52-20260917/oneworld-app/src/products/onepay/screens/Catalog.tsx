...
export default function Catalog() {
 ...
 <button type="button" disabled={busy} onClick={() => save(c.id, c.name, c.price_minor, !c.active)} className="ow-edge ow-tap rounded-full border px-3 py-1 text-[11.5px] font-bold">{c.active ? t("active") : t("inactive")}</button>
          </li>
        ))}
      </ul>
    </div>
