...
export default function InfoTip({ text, label, dismissLabel, action, onAction }: { text: ReactNode; label?: string; dismissLabel?: string; action?: ReactNode; onAction?: () => void }) {
  const { lang } = useI18n();
  ...
  return (
    <>
      ...
      <button type="button" aria-label={label ?? copy.moreInfo} aria-expanded={open}
