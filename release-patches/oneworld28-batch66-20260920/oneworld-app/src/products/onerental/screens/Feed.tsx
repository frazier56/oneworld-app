...
import {
  type Property, type RentalAgent, PROPERTY_COLUMNS, FEED_CARD_COLUMNS, CO_CITIES, priceLabel, priceOnly, rentalPriceDisplay, cop, locationShort,
} from "../lib/rental";
...
import { FeedMedia, FeedVideoPlayer, coverOf, feedLead, feedSlides } from "@oneworld/shell";
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 px-3 pb-2 pt-16 text-white"
        ...
        <TapTarget video={slides[idx]?.kind === "video"} href={href} onPlay={() => setPlaying(idx)}>
          ...
          <CardText
            ...
            priceAlt={altPrice(l.price, l.country, rentalPriceDisplay(l, ccy, fx).currency, fx ?? l.display_fx_rate, cop, n => drawPrice(n, "USD", null), l.currency || "USD")}
            onDark />
        </TapTarget>
