 ...
 */
export default function Splash({ headline, sub, pitch, onSignIn, onJoin, wordmark, below, topSlot }:
  { headline: string; sub: string;
    /**
     * A row ABOVE the language picker, for controls that get you off this screen.
     * ⚠️ Only One World passes this. The eight product splashes pass nothing and render exactly
     * what they rendered before — a launch screen for a product you arrived at has nowhere to go
     * back to. Your World is different: Lee, 21 Sep 2026, *"if you're on this Your World page,
     * there's nowhere to go but forward"* — you now reach it from the hamburger, so it needs a
     * way back and a way to the feed.
     */
