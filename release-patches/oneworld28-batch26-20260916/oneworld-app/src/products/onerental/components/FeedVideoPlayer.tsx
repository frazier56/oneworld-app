...
export default function FeedVideoPlayer({ url, poster, title, href, lang, onClose }: {
  ...
  return (
    <div className="fixed inset-0 z-[2000] bg-black" role="dialog" aria-modal="true" aria-label={title}>
      ...
      {/* Bottom: the way ONWARDS. Lee asked for it here, in the dark band, where a thumb rests
          and where it cannot cover the picture. */}
      ...
      <div className="absolute inset-x-0 bottom-0 p-4"
        ...
        <Link to={href}
          className="ow-tap flex h-12 w-full items-center justify-center rounded-full bg-white text-[15px] font-black text-ink shadow-lg">
