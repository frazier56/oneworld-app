              ...
              <>
                ...
                <div className="max-h-72 overflow-y-auto -mx-1 px-1">
                  ...
                  {results.map((r) => (
                    ...
                    >
                      {r.photo_url
                        ? <img decoding="async" src={r.photo_url} alt="" className="w-9 h-9 rounded-full object-cover" />
                  ...
                  {coOwners.map((row) => (
                    <div key={row.id} className="flex items-center gap-3 p-2 rounded-lg bg-background border border-border">
                      {row.profile?.photo_url
                        ? <img decoding="async" src={row.profile.photo_url} alt="" className="w-9 h-9 rounded-full object-cover" />
