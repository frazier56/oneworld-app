  ...
  return createPortal(
    <div className="fixed inset-0 z-[95] flex items-end justify-center sm:items-center"
      ...
      <div onClick={e => e.stopPropagation()}
        className="max-h-[92svh] w-full max-w-md overflow-y-auto rounded-t-3xl border border-white/40 p-4 sm:rounded-3xl dark:border-white/12"
        style={{
        ...
        <div className="overflow-hidden rounded-2xl border border-ink/10 bg-ink/[.04] dark:border-white/10 dark:bg-black/30">
          {err ? (
            ...
            <img decoding="async" src={url} alt="Your Reputation Passport card" className="block w-full" />
          ) : (
        ...
        {badgeUrl && (
          <div className="mt-4 border-t border-ink/10 pt-3 dark:border-white/10">
            ...
            <img decoding="async" src={badgeUrl} alt="Your reputation badge" className="mx-auto block w-[80%]" />
            <button
